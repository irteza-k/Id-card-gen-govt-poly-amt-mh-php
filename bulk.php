...
<body class="cbp-spmenu-push">
      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
              	  <a  href="bulk.php" ><i class='fa fa-print'></i>Refresh</a>
               </li>
	...
	<!--footer-->
	<div class="footer">
	   <p>  <a href="#" target="">@2021 Batch GROUP C ~ASIA~ [Aatif(18IF201),Shubham(18IF213),Irteza(18IF208),Ashvini(17IF026)]</a></p>		
	</div>
    <!--//footer-->
	</div>
