...
<body class="" style="background-image: url('images/GPA3.png'); background-size: cover;">
<div role="navigation" class="navbar navbar-default navbar-static-top">
      <div class="container">
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
          	<li ><img src="images/GPA.png" alt="text" width="75px" height="75px"></li> 
             <li ><p align="title" style="margin:all;color:darkred;font-style: italic;font-weight: bold;font-size:38px;font-family:serif;">Government Polytechnic,Amravati Online Staff ID Card Generator</p></li>            
          </ul>
